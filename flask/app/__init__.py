...
class Kenniskaart(db.Model):
    ...
    what = db.Column(db.String(16383))
    why = db.Column(db.String(16383))
    how = db.Column(db.String(16383))
    voorbeeld = db.Column(db.String(16383))
    bronnen = db.Column(db.String(16383))
