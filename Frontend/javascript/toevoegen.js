function kenniskaart_toevoegen() {
	...
	*/
	...
	let dataKenniskaart = {
		...
		"hboi": hboi.concat(document.getElementById('formArchitectuurlagen').value, document.getElementById('formActiviteiten').value, document.getElementById('formNiveau').value),
